...
if __name__ == '__main__':
     ...
     **{
     ...
     if snr_conditioned == 'fixed' or snr_conditioned == 'true':
          experiment_name = '{0}_{1}{2}_{3}_wsc'.format(model_type, snr_conditioned, fixed_snr, sigma_max)
     else:
          experiment_name = '{0}_{1}_{2}_{3}_wsc'.format(model_type, snr_conditioned, sigma_max, transform_type)

     if not args.nolog:
          #this needs to be changed accordingly to your wandb settings
          logger = WandbLogger(project="sgmse-bbed_2", entity = 'yhjeon-a', log_model=True, save_dir="logs")
     ...
     # Train model
     checkpoint_file = '/home/yhjeon/projects/self_researches/sgmse_bbed_2/sgmse_bbed/sgmse-bbed/savedir/sebridge_v3_true0.17783_1.0_wsc/epoch=110-last.ckpt'
