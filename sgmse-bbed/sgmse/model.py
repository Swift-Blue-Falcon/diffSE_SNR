...
snr_model = SNRModel.load_from_checkpoint(
            '/home/yhjeon/projects/self_researches/sgmse_bbed_2/sgmse_bbed/sgmse-bbed/savedir/snr_estimator_VBD/epoch=96-snr_error=1.42.ckpt', base_dir="",
        ...
        **kwargs
        ...
        if self.snr_conditioned == 'false':
            if self.model_type == 'bbed':
                ...
                with open('/home/yhjeon/projects/self_researches/sgmse_bbed/cos_sim_noisy.txt', 'a') as f:
                    f.write(f'{self.cos_sim(Z_detach, Y_X_diff)}\n')
                
                with open('/home/yhjeon/projects/self_researches/sgmse_bbed/cos_sim_enhanced.txt', 'a') as f:
                    f.write(f'{self.cos_sim(Z_detach, sample_X_diff)}\n')
